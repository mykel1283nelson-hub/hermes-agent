...
TASK_COMPLETION_GUIDANCE = (
    ...
    "If you change configuration, do not call it fixed until the owning process "
    "accepts that configuration without warnings and a focused live check or "
    "test proves the changed behavior. If validation shows the setting was "
    "ignored, say the attempted fix failed and continue from the evidence."
)
...
COMPUTER_USE_GUIDANCE = (
    ...
    "those prompt classes when a native route is already available.\n"
    ...
    "- Do not retrieve, store, transmit, paste, or log passwords. If the helper "
    "is missing or cannot satisfy the job, classify the exact blocker with "
    ...
    "- Do NOT type passwords, API keys, credit card numbers, or other secrets.\n"
